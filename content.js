...
function editElementsByType(testId, type, callback) {
  document.querySelectorAll(`[${type}="${testId}"]`).forEach(callback);
}
...
function ecosiaEdits() {
  ...
  editElementsByType("search-navigation-item-images", "data-test-id", (el) => {
